        ...
        <section className='bg-[#e9e9e9] w-full justify-between items-center px-5 mt-3 animate__animated animate__slideInRight animate__delay-3s	 '>
            ...
            <div className='px-3 py-4 my-2 w-full'>
                ...
                <div className='flex gap-2 justify-between items-center'>
                    ...
                    <img className='rounded-xl w-1/4 h-2/4 border-1 border-gray-500 shadow-xl' src="/dental.5.png" alt="dental-care"></img>
                    <img className='rounded-xl w-1/4 h-2/4 border-1 border-gray-500  shadow-xl' src="/dental.1.png" alt="dental-care"></img>
                    <img className='rounded-xl w-2/4 h-2/4 border-1 border-gray-500 shadow-xl' src="/dental.3.png" alt="dental-care"></img>
                </div>
